...
import utility.serialization.SerializeToJson;
    ...
    public static List<AccountDTO> readAccount(String path, List<CustomerDTO> customerList) throws IOException {
        ...
        try (
            ...
            for (CSVRecord csvRecord : csvParser) {
                ...
                }catch (CheckAccountCustomerException | NullDataException | AccountNumberException |
                        AccountBalanceException | AccountTypeException e){
